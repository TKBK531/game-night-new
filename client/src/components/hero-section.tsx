    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className={`relative z-10 text-center max-w-6xl mx-auto px-4 ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="gaming-border rounded-xl p-6 backdrop-blur-sm bg-[#111823]/50 hover-lift animate-slide-in-left" style={{ animationDelay: '0.6s' }}>
            <Gamepad2 className="text-3xl text-[#ff4654] mx-auto mb-3 animate-pulse" />
            <div className="text-2xl font-orbitron font-bold text-[#ff4654]">₹1.25L+</div>
            <div className="text-gray-400">Total Prize Pool</div>
          </div>
          <div className="gaming-border rounded-xl p-6 backdrop-blur-sm bg-[#111823]/50 hover-lift animate-slide-up" style={{ animationDelay: '0.7s' }}>
            <Shield className="text-3xl text-[#ffffff] mx-auto mb-3 animate-pulse" />
            <div className="text-2xl font-orbitron font-bold text-[#ffffff]">16 Teams</div>
            <div className="text-gray-400">Elite Competitors</div>
          </div>
          <div className="gaming-border rounded-xl p-6 backdrop-blur-sm bg-[#111823]/50 hover-lift animate-slide-in-right" style={{ animationDelay: '0.8s' }}>
            <Cpu className="text-3xl text-[#ba3a46] mx-auto mb-3 animate-pulse" />
            <div className="text-2xl font-orbitron font-bold text-[#ba3a46]">8 Hours</div>
