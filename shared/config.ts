...
export const siteConfig = {
    ...
    event: {
        ...
        description: "Experience the thrill of competitive gaming with top prizes and unforgettable moments",
        year: "2025"
    },
    ...
    features: {
        reactionGame: {
            ...
            description: "Test your reflexes and compete for the fastest reaction time!",
            leaderboardLimit: 10
        },
        teamRegistration: {
            enabled: true,
